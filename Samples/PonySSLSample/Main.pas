...
uses
  Classes, SysUtils, Graphics, Forms, Controls, StdCtrls, ExtCtrls, Dialogs, Spin
  {$ifdef FPC}
  {$else}
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants,
  System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Pony,
  Vcl.StdCtrls, Vcl.Samples.Spin, Vcl.Mask, Vcl.ExtCtrls, Vcl.ComCtrls, Spin,
...
// use a valid certificate, such as Let's Encrypt.
  ...
  TPony.Get('/ping',
    procedure(Res: TPonyResponse)
    begin
      Res.Send('securite pong');
    end);

  TPony.Listen(edtPort.Value,
    procedure(Pony: TPony)
    begin
