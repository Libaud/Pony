...
{$IFNDEF UseTPonyMimeTypesExt}
  uses
    System.Net.Mime;
{$endif}

type
  TPonyMimeTypesExt = class
  strict private
    class var
      FLock: TCriticalSection;
      FInstance: TPonyMimeTypesExt;
    class constructor Create;
    class destructor Destroy;
    class function GetDefault: TPonyMimeTypesExt; static;
  private
    FFileType: {$ifdef FPC}specialize{$endif} TDictionary<string, string>;
  ...
  public
    ...
    class property Default: TPonyMimeTypesExt read GetDefault;
  end;

{ TPonyMimeTypes }

class function TPonyMimeTypes.GetExtType(const AFileExt: string): string;
  {$IFNDEF UseTPonyMimeTypesExt}
  var
...
begin
  ...
  {$else}
  Result:= TPonyMimeTypesExt.Default.GetExtType(AFileExt);
  {$endif}
end;

class function TPonyMimeTypes.GetFileType(const AFileName: string): string;
  {$IFNDEF UseTPonyMimeTypesExt}
  var
    LKind: TMimeTypes.TKind;
  {$endif}
begin
  ...
  {$else}
  Result:= TPonyMimeTypesExt.Default.GetFileType(AFileName);
  {$endif}
end;

{ TPonyMimeTypesExt }

constructor TPonyMimeTypesExt.Create;
begin
  FFileType:= {$ifdef FPC}specialize{$endif} TDictionary<string, string>.Create;
end;

destructor TPonyMimeTypesExt.Destroy;
begin
  FFileType.Clear;
  FreeAndNil(FFileType);
end;

class constructor TPonyMimeTypesExt.Create;
begin
  FLock:= TCriticalSection.Create;
end;

class destructor TPonyMimeTypesExt.Destroy;
begin
  FreeAndNil(FInstance);
  FreeAndNil(FLock);
end;

class function TPonyMimeTypesExt.GetDefault: TPonyMimeTypesExt;
begin
  ...
  begin
    ...
    try
      if FInstance = nil then
      begin
        FInstance:= TPonyMimeTypesExt.Create;
...
function TPonyMimeTypesExt.NormalizeExt(const AFileExt: String): string;
begin
...
function TPonyMimeTypesExt.GetExtType(const AFileExt: string): string;
var
  LFileExt: string;
begin
...
function TPonyMimeTypesExt.GetFileType(const AFileName: string): string;
begin
  Result:= GetExtType(AFileName);
end;

procedure TPonyMimeTypesExt.InitializeFileType;
begin
